...
/**
 * Created by clam314 on 2017/3/2
 */

public class PierreBezierCircleView extends View {
    private Path mPath;
...
//    private float moveDistance;
    ...
    public PierreBezierCircleView(Context context) {
        this(context, null, 0);
    }

    public PierreBezierCircleView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PierreBezierCircleView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        moveDistance = radius*(3/5f);
    ...
    static class VPoint{
        ...
        void adjustY(float offset){
            top.y -= offset;
            bottom.y += offset;
        }

        void adjustAllX(float offset){
            this.x+= offset;
            top.x+= offset;
            bottom.x+=offset;
        }
